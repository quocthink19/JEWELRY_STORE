    ...
    return (
        <div className='lg:px-20 px-5 pb-10'>
            <div className='py-5 flex justify-center items-center gap-5'>
                <h1 className='text-2x1 lg:text-7x1 text-center font-bold p-5' style={{ fontSize: '36px', color: 'black', fontWeight: 'bold' }}>
                    {area.usersArea?.name}
                </h1>
                <div>
                    <Button
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className='space-y-4 text-gray-200'>
                                <div className='flex'>
                                    <p className='w-48' style={{ color: 'black', fontWeight: 'bold' }}>STAFF</p>
                                    <p className='text-gray-400' style={{ color: 'black', fontWeight: 'bold' }}>
                            ...
                            <div className='space-y-4 text-gray-200'>
                                <div className='flex'>
                                    <p className='w-48' style={{ color: 'black', fontWeight: 'bold' }}>Jewelry name</p>
                                    <p className='text-gray-400' style={{ color: 'black', fontWeight: 'bold' }}>
                                        <span className='pr-5'>-</span>
                                        {area.usersArea?.name}
                                    </p>
                            ...
                            <div className='space-y-4 text-gray-200'>
                                <div className='flex'>
                                    <p className='w-48' style={{ color: 'black', fontWeight: 'bold' }}>Jewelry Type</p>
                                    <p className='text-gray-400' style={{ color: 'black', fontWeight: 'bold' }}>
                                        <span className='pr-5'>-</span>
                                        {area.userArea?.type}
                                    </p>
                            ...
                            <div className='space-y-4 text-gray-200'>
                                <div className='flex'>
                                    <p className='w-48' style={{ color: 'black', fontWeight: 'bold' }}>Opening Hours</p>
                                    <p className='text-gray-400' style={{ color: 'black', fontWeight: 'bold' }}>
                                        <span className='pr-5'>-</span>
                            ...
                            <div className='space-y-4 text-gray-200'>
                                <div className='flex'>
                                    <p className='w-48' style={{ color: 'black', fontWeight: 'bold' }}>Status</p>
                                    <p className='text-gray-400' style={{ color: 'black', fontWeight: 'bold' }}>
                                        <span className='pr-5'>-</span>
                ...
                <Grid item xs={12} lg={6}>
                    <Card>
                        ...
                        <CardContent>
                            <div className='space-y-4 text-gray-200'>
                                <div className='flex'>
                                    <p className='w-48' style={{ color: 'black', fontWeight: 'bold' }}>Email</p>
                                    <p className='text-gray-400' style={{ color: 'black', fontWeight: 'bold' }}>
                                        <span className='pr-5'>-</span>
                            ...
                            <div className='space-y-4 text-gray-200'>
                                <div className='flex'>
                                    <p className='w-48' style={{ color: 'black', fontWeight: 'bold' }}>Mobile</p>
                                    <p className='text-gray-400' style={{ color: 'black', fontWeight: 'bold' }}>
                                        <span className='pr-5'>-</span>
                            ...
                            <div className='space-y-4 text-gray-200'>
                                <div className='flex'>
                                    <p className='w-48' style={{ color: 'black', fontWeight: 'bold' }}>Social</p>
