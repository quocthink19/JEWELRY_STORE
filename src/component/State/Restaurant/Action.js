...
export const updateRestaurant = ({restaurantId, restaurantData, jwt }) => {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch({type:UPDATE_RESTAURANT_STATUS_SUCCESS,payload:res.payload});
        } catch (error) {
...
export const deleteRestaurant = ({restaurantId, jwt }) => {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch({type:DELETE_RESTAURANT_SUCCESS,payload:res.payload});
        } catch (error) {
            console.log("catch error", error);
...
export const createEventAction = ({data, jwt, restaurantId }) => {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch({type:CREATE_EVENTS_SUCCESS, payload:res.payload});
        } catch (error) {
...
export const getAllEvents = ({ jwt }) => {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch({type:GET_ALL_EVENTS_SUCCESS, payload:res.payload});
        } catch (error) {
            console.log("catch - ", error);
...
export const getRestaurantsEvents = ({ restaurantId, jwt}) => {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch({type:GET_RESTAURANTS_EVENTS_SUCCESS, payload:res.payload});
        } catch (error) {
